      ...
      <ScrollArea className="h-full custom-scrollbar">
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            <div className={`w-20 h-20 mx-auto rounded-2xl ${assistant.color} flex items-center justify-center text-3xl mb-4`}>
              {assistant.avatar}
            </div>
            <h2 className="text-xl font-bold text-gray-900">{assistant.name}</h2>
            <p className="text-gray-600 font-medium">{assistant.role}</p>
